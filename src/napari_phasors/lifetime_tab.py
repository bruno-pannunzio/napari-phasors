...
from ._utils import HistogramWidget, ResponsiveFormContainer, update_frequency_in_metadata
...
class LifetimeWidget(QWidget):
    ...
    def plot_lifetime_histogram(self):
        ...
        if self.per_layer_lifetime_data and len(self.per_layer_lifetime_data) > 1:
            self.histogram_widget.update_multi_data(self.per_layer_lifetime_data)
        else:
